...
namespace Common.Classes
{
    ...
    {
        candle60s, // 1分钟K线数据频道
        candle180s, // 3分钟K线数据频道
        candle300s, // 5分钟K线数据频道
        candle900s, // 15分钟K线数据频道
        candle1800s, // 30分钟K线数据频道
        candle3600s, // 1小时K线数据频道
        candle7200s, // 2小时K线数据频道
        candle14400s, // 4小时K线数据频道
        candle21600s, // 6小时K线数据频道
        candle43200s, // 12小时K线数据频道
        candle86400s, // 1day K线数据频道
        candle604800s // 1week K线数据频道
    }
    ...
    public enum MarketTypeEnum:int
    {
        None = 0,
        OTCMarket = 1,
        CTCMarket = 2
